...
def log_ekle(deger):
    ...
    try:
        # Dosyayı aç, ekleme modunda aç (varsa dosyayı ekler, yoksa oluşturur)
  ...
  def start_simulation(self):
        while True:
          ...
          for customer in customers:
              str=f"Customer ID: {customer.id}, Customer Priority: {customer.priority}"
              print(str)
              log_ekle(str)
...
class Customer(threading.Thread):
    ...
    def run(self):
        str=f"Customer-{self.id} is Entered in Restaurant"
        print(str)
        log_ekle(str)
        ...
        if self.restaurant.available_tables:
          ...
          str=f"Customer-{self.id} is seated at Table-{self.table_number}"
          print(str)
          log_ekle(str)
          ...
          str=f"Customer-{self.id} left Table-{self.table_number}"
          print(str)
          log_ekle(str)
...
class Waiter(threading.Thread):
  ...
  def take_order(self, customer_id):
        str=f"Waiter-{self.id} took order from Customer-{customer_id}."
        print(str)
        log_ekle(str)
...
class Chef(threading.Thread):
    ...
    def run(self, customer_id):
        str=f"Chef-{self.id} is preparing the order for Customer-{customer_id}."
        print(str)
        log_ekle(str)
        ...
        str=f"Chef-{self.id} finished preparing the order for Customer{customer_id}."
        print(str)
        log_ekle(str)
...
class Cashier(threading.Thread):
    ...
    def receive_payment(self, customer_id):
        ...
        str=f"Cashier-{self.id} received payment from Customer-{customer_id}."
        print(str)
        log_ekle(str)
        str=f"Total Customer: {total_customers}"
        print(str)
        log_ekle(str)
